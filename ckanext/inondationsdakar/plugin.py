...
class InondationsDakarPlugin(plugins.SingletonPlugin,
    ...
    def setup_template_variables(self, context, data_dict):
        InondationsDakarPlugin.num_times_setup_template_variables_called += 1
        return super(InondationsDakarPlugin, self).setup_template_variables(
                context, data_dict)

    def new_template(self):
        InondationsDakarPlugin.num_times_new_template_called += 1
        return super(InondationsDakarPlugin, self).new_template()

    def read_template(self):
        InondationsDakarPlugin.num_times_read_template_called += 1
        return super(InondationsDakarPlugin, self).read_template()

    def edit_template(self):
        InondationsDakarPlugin.num_times_edit_template_called += 1
        return super(InondationsDakarPlugin, self).edit_template()

    def search_template(self):
        InondationsDakarPlugin.num_times_search_template_called += 1
        return super(InondationsDakarPlugin, self).search_template()

    def history_template(self):
        InondationsDakarPlugin.num_times_history_template_called += 1
        return super(InondationsDakarPlugin, self).history_template()

    def package_form(self):
        InondationsDakarPlugin.num_times_package_form_called += 1
        return super(InondationsDakarPlugin, self).package_form()

    # check_data_dict() is deprecated, this method is only here to test that
    # legacy support for the deprecated method works.
    def check_data_dict(self, data_dict, schema=None):
        InondationsDakarPlugin.num_times_check_data_dict_called += 1
